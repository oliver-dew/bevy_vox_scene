...
pub struct VoxelScene {
    ...
    pub(crate) model_collection: Handle<ModelCollection>,
}
...
pub struct VoxelModelInstance {
    ...
    pub collection: Handle<ModelCollection>,
    /// The index of the model within the collection
